...
import {getCategoryById, newCategory, updateCategory} from "../../../api/category";
...
const NewCategory = () => {
  ...
  const {
    ...
    isLoading,
    isError
  } = useQuery(["getCategoryById", id], getCategoryById, {
    enabled: !!id,
  });
  const mutation = useMutation({ mutationFn: newCategory });
              ...
              <>
                ...
                <Stack direction="row" spacing={2}>
                  <ThemeProvider theme={themeCustom}>
                    <Button type="submit" variant="contained" color="custom_black" onClick={() => navigate("/master-data-registry/categories")}>
                      Cancel
                    </Button>
