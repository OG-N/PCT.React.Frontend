          ...
          <Card>
            <CardContent>
              ...
              <Box px={4} my={3} sx={{ fontSize: 17, color: "#333333" }}>
                <Grid container spacing={6}>
                  <Grid item md={12}>
                    <a target="_blank" rel="noopener noreferrer" href="https://thepalladiumgroup.atlassian.net/wiki/spaces/GISS/pages/2118385665/Quantification+Reports">{t('Quantification Reports')}</a>
                    <Divider />
                  </Grid>
                  <Grid item md={12}>
                    <NavLink to={`/plan/quarterly-supply-plans`}>
                      {t('Quarterly Supply Plans')}
                    </NavLink>
                    <Divider />
                  </Grid>
                  <Grid item md={12}>
                    <NavLink to={`/plan/quarterly-supply-plans`}>
                      {t('Historical Distribution Orders')}
                    </NavLink>
                    <Divider />
                  </Grid>
                  <Grid item md={12}>
                    <NavLink to={`/plan/psa-inbound-product-monitoring`}>
                      {t('PSA Inbound Product Monitoring')}
                    </NavLink>
                    <Divider />
                  </Grid>
                  <Grid item md={12}>
                    <NavLink to={`/plan/customs-clearance`}>
                      {t('Custom Clearance Monitoring')}
                    </NavLink>
                    <Divider />
                  </Grid>
                  <Grid item md={12}>
                    <NavLink to={`/plan/custom-requirements`}>
                      {t('Customs Requirements')}
                    </NavLink>
                    <Divider />
                  </Grid>
                </Grid>
                ...
                <Grid container spacing={1}>
                  <Grid item md={12}>
                    <Card>
                      <CardContent>
                        <Typography gutterBottom variant="h5" component="div">
                          {t('Inbound Visibility')}
                        </Typography>
                        <Box px={4} my={3} sx={{ fontSize: 17, color: "#333333" }}>
                          <Grid container spacing={6}>
                            <Grid item md={12}>
                              <NavLink to={`/shipment/pos`}>
                                {t('Advanced Shipment Notice(ASN)')}
                              </NavLink>
                              <Divider />
                            </Grid>
                            <Grid item md={12}>
                              <NavLink to={`/shipment/pos-validated`}>
                                {t('Advanced Shipment Notice(ASN) - Validated')}
                              </NavLink>
                              <Divider />
                            </Grid>
                            <Grid item md={12}>
                              <NavLink to={`/plan/inbound-milestone-monitoring`}>
                                {t('Inbound Milestone Monitoring')}
                              </NavLink>
                              <Divider />
                            </Grid>
                          </Grid>
                          ...
                          <Grid container spacing={6}>
                            <Grid item md={12}>
                              <NavLink to={`/customer-orders/pos`}>
                                {t('Distribution Order Requests')}
                              </NavLink>
                              <Divider />
                            </Grid>
                            <Grid item md={12}>
                              <NavLink to={`/customer-orders/pos-validated`}>
                                {t('Distribution Order Requests - Validated')}
                              </NavLink>
                              <Divider />
                            </Grid>
                            <Grid item md={12}>
                              <NavLink to={`/plan/outbound-milestone-monitoring`}>
                                {t('Outbound Milestone Monitoring')}
                              </NavLink>
                              <Divider />
                            </Grid>
                          </Grid>
                ...
                <Grid container spacing={6}>
                  ...
                  <Grid item md={12}>
                    <NavLink to={`/plan/inbound-inventory-monitoring`}>
                      {t('Inbound Inventory Monitoring')}
                    </NavLink>
                    <Divider />
                  </Grid>
                  <Grid item md={12}>
                  ...
                  <Grid item md={12}>
                    <NavLink to={`/plan/supply-and-demand`}>
                      {t('Supply and Demand Reconciliation')}
                    </NavLink>
                    <Divider />
                  </Grid>
                  <Grid item md={12}>
