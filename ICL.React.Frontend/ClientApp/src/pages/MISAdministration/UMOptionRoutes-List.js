    ...
    const mutation = useMutation({
        mutationFn: async (updatedOptionRoute) => {
            try {
                ...
                setSuccessMessage("Application section information changed successfully.");
                refetch();
            } catch (error) {
                setErrorMessage("Error updating application section information.");
    ...
    const handleCreateNewOptionRoute = async () => {
        try {
            if (!selectedOptionRoute.category) {
                setErrorMessage("Please provide a value for the Category field.");
                return;
            }
            if (!selectedOptionRoute.name) {
                setErrorMessage("Please provide a value for the Name field.");
                return;
            }

            await newicl_options_route(selectedOptionRoute);
            setSuccessMessage("Application section created successfully.");
            refetch();
            setCreateDialogOpen(false);
        } catch (error) {
            setErrorMessage("Error creating application section.");
    ...
    const handleDeleteOptionRoute = async (id) => {
        if (
            ...
            try {
                ...
                setSuccessMessage("Application section status changed successfully.");
                refetch();
            } catch (error) {
